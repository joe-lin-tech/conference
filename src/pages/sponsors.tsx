...
const Sponsors = () => {
  return (
    <PageLayout page="Sponsors">
      <section className="px-4 pt-4 pb-10 mx-auto max-w-7xl">
        <div className="container px-6 py-10 mx-auto">
          <h1 className="text-4xl font-extrabold text-center leading-none tracking-normal text-gray-900 md:text-6xl md:tracking-tight">Sponsors</h1>
          ...
          <p className="mt-6 text-lg text-center text-gray-600 md:text-xl lg:px-24">
            Check out our sponsors that made this autonomous vehicle conference possible!
          </p>
        </div>
